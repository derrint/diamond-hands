...
const SectionGame = () => {
  ...
  React.useEffect(() => {
    ...
    const context = new UnityContext({
      loaderUrl: '/static/game/Build/jankenpon.loader.js',
      dataUrl: '/static/game/Build/jankenpon.data',
      frameworkUrl: '/static/game/Build/jankenpon.framework.js',
      codeUrl: '/static/game/Build/jankenpon.wasm',
    });
